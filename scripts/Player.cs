...
public class Player : KinematicBody
{
    ...
    private TerminalContainer _terminal;
    ...
    public override void _Ready()
    {
        ...
        _terminal = GetNode<TerminalContainer>("GUI/Terminal");
    ...
    private void ProcessInput(float delta)
    {
        ...
        if (Input.IsActionJustPressed("action_1"))
        {
            ...
            if (lookingAtObject is Node node && node.GetParent() is ComputerContainer container)
            {
    ...
    public override void _Input(InputEvent @event)
    {
        ...
        if (@event is InputEventMouseButton mouseButton && mouseButton.Pressed && Input.GetMouseMode() == Input.MouseMode.Captured)
        {
            var lookingAtObject = _rayCast.GetCollider();
            ...
            if (lookingAtObject != null)
            {
                ...
                if (parent is ComputerContainer c)
                {
